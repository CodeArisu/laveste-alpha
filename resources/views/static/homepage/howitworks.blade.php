@push('styles')
    <link rel="stylesheet" href="{{ asset('/css/homepage/howitworks.css') }}">
@endpush
    ...
    <div class="list_container">
        <div class="icon_content">
            <ul>
                ...
                <li><i class="fa-solid fa-list-check"></i></li>
                <li><i class="fa-solid fa-calendar-check"></i></li>
        ...
        <div class='text_header'>
            <ul>
                ...
                <li>Pay for the service and checkout</li>
            </ul>
        </div>
